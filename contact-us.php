...
<head>
    ...
    <title>Contact US - getinfo4free  </title>
    <meta name="description" content="Contact to getinfo4free Have questions about background screening? Our entire team receives specialized training regularly to ensure you’re receiving the best information possible. " />
    <meta name="keywords" content="contact getinfo4free , Contact getinfo4free.com" />
   
    <link rel=" canonical" href="https://www.getinfo4free.in/contact-us.php" />

    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="Contact US - getinfo4free " />
    <meta property="og:description" content="Contact to getinfo4free Have questions about background screening? Our entire team receives specialized training regularly to ensure you’re receiving the best information possible." />
    <meta property="og:url" content="https://www.getinfo4free.in/contact-us.php" />
...
<body class="home blog custom-background wp-custom-logo full-width font-family hfeed">
    ...
    <div class="container">
        <div class="row">
            <!--breadcrumb-->
            <div class="col-12">
                <div class="breadcrumb u-breadcrumb  pt-3 px-0 mb-0 bg-transparent small"><a class="breadcrumb-item" href="https://www.getinfo4free.com">Home</a>&nbsp;&nbsp;»&nbsp;&nbsp;Contact Us</div>
            </div>
        </div>
            ...
            <div class="col-md-8">
                ...
                <article class="post-782 page type-page status-publish hentry" id="post-782">
                    ...
                    <div class="entry-content post-content post-page">
                        ...
                        <p>At Choice you always talk to a human! Have questions about background screening? Our entire team receives specialized training regularly to ensure you’re receiving the best information possible. From basic questions to complex compliance inquiries, we’re here to help!</p>
                            ...
                            <form name="contact" method="post" id="contact_form_submit">
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-4">
                                        <div class="form-group form-element">
                                            <input type="text" class="form-control input-field" id="name" name="name" placeholder="Your Name">
                                        </div>
                                    </div>
                                    <div class="col-md-12 mb-4">
                                        <div class="form-group form-element">
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-4">
                                        ...
                                        <div class="form-group form-element">
                                            <textarea id="message" name="message" cols="30" rows="10" class="form-control" placeholder="Write Your Message"></textarea>
                                        </div>
                                    </div>
                                </div>
