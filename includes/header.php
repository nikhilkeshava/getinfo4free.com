            ...
            <nav class="navbar navbar-expand d-lg-none navbar-light px-0">
              ...
              >
                ...
                <ul id="mobile-menu1" class="navbar-nav">
                  ...
                  >
                    <a title="About" href="about-us.php" class="nav-link"
                      >About us</a
                    >
                  </li>
                  <li
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-lg-4">
                ...
                <div
                  id="main-logo"
                  class="main-logo my-2 my-lg-4 d-none d-lg-block text-center-md-down"
                >
                  <a
                    href="index.php"
              ...
              <div class="col-lg-8">
                ...
                <div
                  id="custom_html-1"
                  class="widget_text my-2 my-md-3 my-lg-4 d-none d-md-block text-center"
                >
