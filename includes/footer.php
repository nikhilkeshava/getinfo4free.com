<footer>
        ...
        <div
          id="footer"
          class="footer-dark bg-dark bg-footer py-5 px-3"
                ...
                >
                  <div class="block-area">
                    ...
                    <img
                      ...
                      alt="footer logo"
                      src="http://localhost/getinfo4free.com/images/getinfo4free.png"
                    />
                    <p>
                      ...
                      <div class="row">
                        <div class="col-3 col-md-4 pe-2 pe-md-0">
                          ...
                          <div class="ratio_110-77 image-wrapper">
                            <a
                              href="<?php echo htmlentities($row['posttitle']);?>"
                            >
                              <img
                                width="110"
                                height="77"
                                src="admin/postimages/<?php echo htmlentities($row['PostImage']);?>" class=" img-fluid lazy wp-post-image" alt="<?php echo htmlentities($row['posttitle']);?>" title="<?php echo htmlentities($row['posttitle']);?>" loading="lazy" data-src="admin/postimages/<?php echo htmlentities($row['PostImage']);?>" srcset="
                        ...
                        <div class="col-9 col-md-8">
                          <div class="card-body pt-0">
                            ...
                            <h3 class="card-title h6 h5-sm h6-md">
                              <a
                                href="<?php echo htmlentities($row['url']);?>"
                ...
                >
                  ...
                  <div class="col-12 insta-list mb-5">
                    ...
                    <?php 
                                                ...
                                                ?>
                      <li
                        class="col-6 col-sm-4 px-0 hover-a mb-0 overflow zoom"
                      >
                        <a
                          href="<?php echo htmlentities($row['url']);?>"
        ...
        <div class="footer-copyright bg-secondary">
          <div class="container">
            ...
            <nav class="navbar navbar-expand navbar-dark px-0">
              ...
              <ul
                id="mobile-menu2"
                class="navbar-nav text-center first-start-lg-0 footer-nav"
              >
                <li
                  itemscope="itemscope"
                ...
                <li
                  ...
                  itemtype="https://www.schema.org/SiteNavigationElement"
                  id="menu-item-1496"
                  class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1496 nav-item"
                >
                  <a
                    title="Contact Us"
                    href="contact-us.php"
