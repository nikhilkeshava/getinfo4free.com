                                ...
                                <article class="card card-full text-light overflow zoom">
                                    ...
                                    <div class="position-absolute p-3 b-0 w-100 bg-lg-shadow">
                                        ...
                                        <h2 class="h1-sm h2-md display-4-lg fw-bold heading-letter-space text-white">
                                            <a class="text-white" href="<?php echo htmlentities($row['url']);?>"><?php echo htmlentities($row['posttitle']);?></a>
                                        </h2>
                                        <!-- author and date -->
                                        <div class="news-meta mb-2">
                                            <span class="news-author white">by
                                                <span class="fw-bold"><a href="#" title="Posts by <?php echo htmlentities($row['authorname']);?>" rel="author"><?php echo htmlentities($row['authorname']);?></a></span></span>
