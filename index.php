...
<head>
    ...
    <!-- extra lunk -->
    <meta name="apple-mobile-web-app-title" content="getinfo4free - Read all type of blogs " />
                    ...
                    <div class="col-md-8">
                        <div class="block-area">
                            ...
                            <div class="block-title-6">
                                ...
                                <ul class="nav nav-tabs nav-block-link1 d-inline" id="cat-tabsone1" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link active" id="cat-navione1" data-bs-toggle="tab" href="#block-catone1" role="tab" aria-controls="block-catone1" aria-selected="true">All</a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link" id="cat-navitwo1" data-bs-toggle="tab" href="#block-cattwo1" role="tab" aria-controls="block-cattwo1" aria-selected="false">Education &
                                            Interview Questions</a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link" id="cat-navithree1" data-bs-toggle="tab" href="#block-catthree1" role="tab" aria-controls="block-catthree1" aria-selected="false">Technical</a>
                                    </li>
                                </ul>
                                <!-- end block nav tabs -->
                                <!-- block nav more-->
                            ...
                            <div id="block-load1" class="tab-content ajax-tabs p-0">
                                <!--tabs content-->
                                <div class="tab-pane fade show active" id="block-catone1" role="tabpanel" aria-labelledby="cat-navione1">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="card-text mb-2 text-muted small">
                                                        ...
                                                        <span class="fw-bold d-none d-sm-inline me-1">
                                                            <a href="#" title="<?php echo htmlentities($row['authorname']);?>" rel="author"><?php echo htmlentities($row['authorname']);?></a>
                                                        </span>
                                                        <!--date-->
                                ...
                                <!--tabs content-->
                                <div class="tab-pane fade" id="block-cattwo1" role="tabpanel" aria-labelledby="cat-navitwo1">
                                    <div class="row animate slideInDown">
                                        <!--big post-->
                                        <div class="col-sm-6 col-md-12 col-lg-6">
                                            <?php 
                                ...
                                <!--tabs content-->
                                <div class="tab-pane fade" id="block-catthree1" role="tabpanel" aria-labelledby="cat-navithree1">
                                    <div class="row animate slideInDown">
                                        <!--big post-->
                                        <div class="col-sm-6 col-md-12 col-lg-6">
                                            <?php 
                                        ...
                                        <article class="card card-full hover-a mb-4">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="card-text mb-2 text-muted small">
                                                    <!--author-->
                                                    <span class="fw-bold d-none d-sm-inline me-1">
                                                        <a href="#" title="Posts by <?php echo htmlentities($row['authorname']);?>" rel="author">
                        ...
                        <div class="block-area">
                            ...
                            <div class="block-title-6">
                                ...
                                <ul class="nav nav-tabs nav-block-link1 d-inline" id="cat-tabsone2" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link active" id="cat-navione2" data-bs-toggle="tab" href="#block-catone2" role="tab" aria-controls="block-catone2" aria-selected="true">All</a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link" id="cat-navitwo2" data-bs-toggle="tab" href="#block-cattwo2" role="tab" aria-controls="block-cattwo2" aria-selected="false">Gadgets
                                            Product Reviews</a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link" id="cat-navithree2" data-bs-toggle="tab" href="#block-catthree2" role="tab" aria-controls="block-catthree2" aria-selected="false">Mobiles and laptops</a>
                                    </li>
                            ...
                            <div id="block-load2" class="tab-content ajax-tabs p-0">
                                <!--tabs content-->
                                <div class="tab-pane fade show active" id="block-catone2" role="tabpanel" aria-labelledby="cat-navione2">
                                                            ...
                                                            <div class="col-3 col-md-4 pe-2 pe-md-0">
                                                                <div class="ratio_115-80 image-wrapper">
                                                                    <a href="<?php echo htmlentities($row['url']);?>">
                                                                        ...
                                                                        admin/postimages/<?php echo htmlentities($row['PostImage']);?> 230w,
                                                                        admin/postimages/<?php echo htmlentities($row['PostImage']);?> 203w,
                                                                        admin/postimages/<?php echo htmlentities($row['PostImage']);?>  165w " sizes="(max-width: 115px) 100vw, 115px" />
                                                                        <!-- post type -->
                                                                        <div class="post-type-icon">
                                                                            <span class="fa-stack-sea text-primary">
                                                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-link" viewBox="0 0 16 16">
                                ...
                                <!--tabs content-->
                                <div class="tab-pane fade" id="block-cattwo2" role="tabpanel" aria-labelledby="cat-navitwo2">
                                    <div class="animate slideInDown">
                                        <!--big post-->
                                        <div class="big-post">
                                            <?php 
                                ...
                                <!--tabs content-->
                                <div class="tab-pane fade" id="block-catthree2" role="tabpanel" aria-labelledby="cat-navithree2">
                                    <div class="animate slideInDown">
                                        <!--big post-->
                                        <div class="big-post">
                                            <?php 
                            ...
                            <div class="row">
                                ...
                                <article class="col-sm-6 col-md-12 col-lg-6">
                                    <div class="card card-full hover-a mb-4">
                                        ...
                                        <a class="bg-full-shadow" href="<?php echo htmlentities($row['url']);?>" aria-label="background shadow"></a>
                                        <div class="position-absolute px-3 top-3 w-100 z-index-5 text-center">
                                            ...
                                            <!--date-->
                                            <time class="d-sm-none d-md-inline m-0 text-white" datetime="<?php echo htmlentities($row['postingdate']);?>"><?php echo htmlentities($row['postingdate']);?></time>
                                        </div>
                                    </div>
                                </article>
                                <?php } ?>
                                                    ...
                                                    <div class="post-type-icon">
                                                        <span class="fa-stack-sea text-primary">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-play-fill" viewBox="0 0 16 16">
                                                                <path d="M11.596 8.697l-6.363 3.692c-.54.313-1.233-.066-1.233-.697V4.308c0-.63.692-1.01 1.233-.696l6.363 3.692a.802.802 0 0 1 0 1.393z"></svg>
